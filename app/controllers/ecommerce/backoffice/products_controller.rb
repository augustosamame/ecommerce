  ...
  class Backoffice::ProductsController < Backoffice::BaseController
    ...
    private
      ...
      def backoffice_product_params
        params.require(:product).permit(:weight, :country, :tipo_producto, :coupon, :coupons, :coupon_id, :tax_1_check, :tax_1_amount, :tax_2_check, :tax_2_amount, :tax_3_check, :tax_3_amount, :status, :brand_id, :supplier_id, :accounting_code_family_id, :name, :short_description, :description, :description2, :price_cents, :discounted_price_cents, :discount_group_id, :costo_cents, :total_quantity, :stockable, :days_to_restock, :home_featured, :product_order, :image, :image_cache, Product.globalize_attribute_names, :show_callout, :callout_label_en, :collout_label_es, :callout_discount, :callout_discount_label_en, :callout_discount_label_es, :cross_sell_default, :component_combo, cross_sell_product_ids: [], cross_parent_ids: [], category_id: [], category_list: [], coupon_ids: [], :product_skus_attributes => [:id, :sku, :price_cents, :status, :_destroy], :combo_components_attributes => [:id, :component_product_id, :quantity, :_destroy], :media_attributes => [:id, :file, :media_type, :position, :_destroy])
      end
