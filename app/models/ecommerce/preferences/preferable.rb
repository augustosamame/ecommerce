...
# Examples:
#
#   # Ecommerce::Base includes Preferable and defines preferences as a serialized
#   # column.
#   class Settings < Ecommerce::Base
...
#   s.save!
module Ecommerce::Preferences::Preferable
  extend ActiveSupport::Concern

  included do
    extend Ecommerce::Preferences::PreferableClassMethods
  end
