...
c1 = Ecommerce::Category.create(name: "Fruits and Vegetables", parent_id: nil, remote_image_url: "https://devtechperu-expatshop-dev.s3.amazonaws.com/uploads/ecommerce/category/image/1/fruits_and_vegetables.jpg", status: "active", category_type: 0, category_order: 1, main_menu: true, popular: false, popular_homepage: true, image_popular_homepage: "https://devtechperu-expatshop-dev.s3.amazonaws.com/uploads/ecommerce/category/image_popular_homepage/1/fruits_and_vegetables.jpg", homepage_cat_image_width: 400, homepage_cat_image_height: 233)
