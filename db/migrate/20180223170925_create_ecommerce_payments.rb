...
class CreateEcommercePayments < ActiveRecord::Migration[5.1]
  def change
    ...
    add_foreign_key :ecommerce_payments, :ecommerce_orders, column: :order_id
    add_foreign_key :ecommerce_payments, :ecommerce_payment_methods, column: :payment_method_id
  end
end
